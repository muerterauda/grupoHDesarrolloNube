...
function addMarker(lon, lat, id, precargando) {
    ...
    if (precargando)
        ...
        labelInput3.id = "labelMarcado_" + cont.toString();
        labelInput3.setAttribute("for", "imagenMarcado_" + cont.toString());
        labelInput3.innerHTML = "<b> Prueba gr&aacute;fica de hallazgo: </b>&nbsp;";
        myDiv.appendChild(labelInput3);
